    ...
    <div class="overflow-hidden">
      <div class="hero_container flex flex-col md:flex-row items-center justify-center">
        ...
        <div class="md:w-1/2 flex justify-center">
          <video autoplay loop muted playsinline class="w-full md:w-auto object-cover h-96 sm:h-[480px]">
      ...
      <div class="max-w-screen-xl px-4 mx-auto">
        <div class="flex justify-center space-x-6">
          <a href="https://www.instagram.com/idrew_dev/" class="text-gray-400 hover:text-orange-400 duration-200">
            ...
            <svg class="w-6 h-6" aria-hidden="true" fill="currentColor" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
